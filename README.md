...
- [4 Code Explanation](#4-code-explanation)
  - [4.1 Configuration & Utilities](#41-configuration--utilities)
    ...
    - [4.1.2 `utils.py` – Small helper functions](#412-utilspy--small-helper-functions)
  - [4.2 Data Cleaning (`data_cleaning.py`)](#42-data-cleaning-data_cleaningpy)
    - [4.2.1 Step-by-step](#421-step-by-step)
  - [4.3 Feature Engineering (`feature_engineering.py`)](#43-feature-engineering-feature_engineeringpy)
    - [4.3.1 Helper `_split_field`](#431-helper-_split_field)
    - [4.3.2 Building encoders (`build_encoders(df)`)](#432-building-encoders-build_encodersdf)
    - [4.3.3 Transforming DataFrame → X, y](#433-transforming-dataframe--x-y)
    - [4.3.4 Preprocessing with optional saving](#434-preprocessing-with-optional-saving)
    - [4.3.5 Preprocess a single movie (for prediction)](#435-preprocess-a-single-movie-for-prediction)
  - [4.4 Training with XGBoost (`train_model.py`)](#44-training-with-xgboost-train_modelpy)
    - [4.4.1 Setup](#441-setup)
    - [4.4.2 Load, preprocess, split](#442-load-preprocess-split)
    - [4.4.3 Model parameters](#443-model-parameters)
    - [4.4.4 Training loop (custom boosting step-by-step)](#444-training-loop-custom-boosting-step-by-step)
